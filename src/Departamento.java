...
public class Departamento {
    ...
    public boolean alterarDepartamento() throws ClassNotFoundException, SQLException {
    ...
    public boolean excluirDepartamento() throws ClassNotFoundException, SQLException {
    ...
    public Departamento consultaDepto() throws ClassNotFoundException, SQLException {
        Connection con = Conexao.conectar();
